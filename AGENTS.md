# KTL - Project Instructions

See `KTL_AI_Instructions.md` for full architecture, conventions, and coding guidelines.
That file is the shared reference for all AI tools and contributors.
