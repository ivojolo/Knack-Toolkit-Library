...
// Find and replace the keyboard shortcut code with single quotes
const oldCode = `// KTL Dev Popup: keyboard shortcuts for copying Scene/View/Field/Object IDs
...
const newCode = `// KTL Dev Popup: keyboard shortcuts for copying Scene/View/Field/Object IDs
(function attachKtlDevPopupShortcuts() {
    // ==== Vars ====
    const FLAG_NAME = 'ktlDevPopupShortcutsAttached';
    const POPOVER_SELECTOR = '#kn-popover';
...
console.log('Quotes fixed - changed all double quotes to single quotes');
